...
class ArDesktop extends StatelessWidget {
  const ArDesktop({super.key});
        ...
        appBar: AppBar(
          ...
          actions: [
            ...
            Padding(
              ...
              child: IconButton(
                  onPressed: () {
                   // Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => const MyDeskTop()));

                   Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => const MyDeskTop())                  );
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          'خبرة اكثر من 15 عام في تدريس وتدريب علوم الحاسب',
                          style: GoogleFonts.cairo(
                              color: Colors.black,
                              fontSize: 16,
                              fontWeight: FontWeight.bold),
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child:  Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                              Text('تواصل معنا',  style: GoogleFonts.cairo(
                                color: Colors.black,
                                fontSize: 20,
                                fontWeight: FontWeight.bold),),
                              Text('لديك فكرة؟ دعنا نتحدث!',  style: GoogleFonts.cairo(
                                  color: Colors.black,
                                  fontSize: 40,
                                  fontWeight: FontWeight.bold)),
                              InkWell(
